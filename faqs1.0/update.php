...
<head>
    ...
    <title>Update FAQ | Catanduanes State University</title>
...
:root {
    ...
    @media (max-width: 768px) {
        ...
        /* Add any update.php specific styles here */
        .edit-card {
...
<body>
    <div class="sidebar">
        ...
        <a href="update.php" class="active"><i class="bi bi-pencil-fill"></i> <span>Update FAQ</span></a>
    ...
    <div class="content-wrapper">
        <div class="card edit-card">
            <div class="card-header">
                <i class="bi bi-pencil-square"></i> Update FAQ
            </div>
            <div class="card-body">
                <?php
                ...
                if (isset($_GET['id'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo '<div class="edit-header">
                                <h2><i class="bi bi-pencil"></i> Edit FAQ</h2>
                                <span class="badge">ID: '.$faq['id'].'</span>
                              </div>
                              <form id="update-faq-form">
                                <input type="hidden" id="faq-id" value="'.$faq['id'].'">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="faq-answer" rows="5" required>'.htmlspecialchars($faq['answer']).'</textarea>
                                </div>
                        ...
                        echo '<div class="alert alert-danger">
                                <i class="bi bi-exclamation-triangle"></i> FAQ not found
                              </div>';
                    }
                    ...
                    echo '<div class="alert alert-info">
                            <i class="bi bi-info-circle"></i> Please select an FAQ to edit from the View FAQs page
                          </div>';
                }
    ...
    document.getElementById('update-faq-form')?.addEventListener('submit', function(e) {
        e.preventDefault();
        
        const formData = new FormData();
        formData.append('id', document.getElementById('faq-id').value);
        formData.append('question', document.getElementById('faq-question').value);
        formData.append('answer', document.getElementById('faq-answer').value);
